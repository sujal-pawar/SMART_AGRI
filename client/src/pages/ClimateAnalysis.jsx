    ...
    <div>
      ...
      <div className="overflow-x-auto pb-2 mb-6">
        <div className="flex space-x-2 min-w-max">
          ...
          <button 
            className="flex items-center px-4 py-2.5 rounded-md bg-white text-gray-700 hover:bg-gray-100 font-medium ml-auto shadow-sm"
          >
            <FontAwesomeIcon icon={faTriangleExclamation} className="text-amber-500 mr-2" />
            Alerts
          </button>
        </div>
      </div>
